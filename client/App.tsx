...
function Placeholder({ name }: { name: string }) { return <div className="mx-auto flex min-h-[60vh] max-w-3xl flex-col items-center justify-center px-5 py-20 text-center"><p className="eyebrow">RAI OG PAVING</p><h1 className="display-title mt-5">{name}</h1><p className="mt-5 max-w-md leading-7 text-[#59655e]">This page is ready for the next build pass. Get in touch now for a free quote.</p></div>; }
